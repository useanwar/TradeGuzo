...
import type { TradeDetail as TradeDetailType, TagOption, CandleBar } from "@/lib/analytics";
...
export default function TradeDetail({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Header spans full width regardless of column layout below */}
      ...
      {/* Two columns at lg+ (chart/execution/notes need the width most);
          single column below lg, in the same reading order as before. */}
          ...
          <div className="rounded-2xl border border-border bg-bg-surface p-5 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4 font-mono text-sm sm:grid-cols-3">
              ...
              <div>
                ...
                {typeof trade.mae === "number" && isFinite(trade.mae) ? (
              ...
              <div>
                ...
                {typeof trade.mfe === "number" && isFinite(trade.mfe) ? (
                ...
                {screenshots.map((s) => (
                  <div key={s.id} className="group relative overflow-hidden rounded-lg border border-border">
                    <a href={s.url} target="_blank" rel="noopener noreferrer">
                      ...
                      <img src={s.url} alt={s.label ?? "Trade screenshot"} className="h-24 w-full object-cover" />
                    </a>
                    <button
